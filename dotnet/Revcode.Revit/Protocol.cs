...
internal sealed record ContextSnapshot(string InstanceId, string RevitVersion, string RevitBuild, string Runtime, DocumentSnapshot? Document, DocumentSnapshot[] Documents, string? CapturedAt = null);
...
internal sealed record RuntimeConfig(string NodePath, string HostPath, string CompilerPath, string DesktopPath);
