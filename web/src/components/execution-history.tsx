...
export function ExecutionHistory({ operations }: { operations: Operation[] }) {
  return (
    <section
      ...
      className="max-h-[38dvh] shrink-0 overflow-y-auto border-t border-line bg-panel px-4 py-3 sm:px-6"
    >
      <div className="mx-auto w-full max-w-[760px]">
        <div className="flex items-center justify-between gap-2">
          <h2 className="text-[13px] font-semibold tracking-tight">Execution history</h2>
          <Badge variant="neutral">{operations.length} operations</Badge>
        </div>
        {operations.length === 0 ? (
