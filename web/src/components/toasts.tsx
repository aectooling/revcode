...
function Toast({ notice, onDismiss }: { notice: ToastNotice; onDismiss(): void }) {
  ...
  return (
    ...
    >
      ...
      />
      <p className="min-w-0 flex-1 whitespace-pre-wrap break-words leading-relaxed text-ink">
        {notice.message}
      </p>
      <button
        type="button"
...
export function ToastRegion({
  ...
  return (
    <div
      className="pointer-events-none fixed right-4 top-14 z-[60] grid w-[min(360px,calc(100%-2rem))] gap-2"
      aria-live="polite"
      aria-atomic="false"
    >
