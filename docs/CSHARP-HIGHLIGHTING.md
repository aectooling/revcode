...
`npm run test:browser`, `npm run test:provider-ui`, `npm run test:skills-runs`, and `npm run test:highlighting` passed in installed Edge; live Revit/provider validation is separate.
